...
namespace ForumApp.BusinessLayer.Interfaces
{
    ...
    {
        Task<ServiceResult<CommentResponseDto>> CreateCommentAsync(CommentCreateDto commentData, int authorId, CancellationToken ct = default);
        ...
        Task<ServiceResult<CommentResponseDto>> UpdateCommentAsync(int commentId, CommentCreateDto commentData, int requestingUserId, CancellationToken ct = default);
