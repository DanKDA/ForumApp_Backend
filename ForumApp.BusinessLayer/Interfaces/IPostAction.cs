...
namespace ForumApp.BusinessLayer.Interfaces
{
    ...
    {
        Task<ServiceResult<PostResponseDto>> CreatePostAsync(PostCreateDto postData, int authorId, CancellationToken ct = default);
        ...
        Task<ServiceResult<PostResponseDto>> UpdatePostAsync(int postId, PostUpdateDto postData, int requestingUserId, CancellationToken ct = default);
